...
public:
    ...
    void add_road(int x, int y, int weight);     //增加道路
    void del_road(int x, int y);                 //删除道路
    void update_road(int x, int y, int weight);  //更新道路

    bool judge_path_exist(int x, int y);         //判断道路是否存在
